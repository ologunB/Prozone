...
class _ProDetailsScreenState extends State<ProDetailsScreen> {
  ...
  void initState() {
    ...
    stateSelected = widget.model.state == null ? "No State" : widget.model.state.name;
    ratingSelected = widget.model.rating;
    providerTypeSelected =
        widget.model.providerType == null ? "No Provider Type" : widget.model.providerType.name;
    statusSelected = widget.model.activeStatus ?? " - pending";
    super.initState();
  }
                                      ...
                                      return Padding(
                                          ...
                                          child: Stack(
                                            children: [
                                              ...
                                              GestureDetector(
                                                onTap: () {
                                                  selectedPictures.remove(selectedPictures[index]);
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        verticalSpaceSmall,
                        Text(
                          "${addressController.text ?? "No Address"}, ${stateSelected ?? "No State"}",
                          style: GoogleFonts.nunito(
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(color: Styles.colorBlack.withOpacity(0.2), width: 2)),
                      padding: EdgeInsets.symmetric(horizontal: 4),
                      child: DropdownButton<String>(
                        hint: Text(
                          "Select...",
                          style: GoogleFonts.nunito(
                              fontSize: 14.0, color: Styles.colorGrey, fontWeight: FontWeight.w600),
                        ),
